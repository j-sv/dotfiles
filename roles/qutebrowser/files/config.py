...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-J>': '<Return>', '<Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-6>': '<Ctrl-^>', '<Shift-Return>': '<Return>', '<Ctrl-[>': '<Escape>', '<Shift-Enter>': '<Return>'}

## Background color of the completion widget category headers.
## Type: QssColor
# c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #888888, stop:1 #505050)'
c.colors.completion.category.bg = base2

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = base2

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = base2
...
## Type: QssColor
c.colors.completion.scrollbar.fg = base2
...
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = base3
...
## Type: Font
c.fonts.prompts = '14px sans-serif'
...
## Type: Padding
# c.statusbar.padding = {'right': 0, 'top': 1, 'bottom': 1, 'left': 0}
...
## Type: Padding
# c.tabs.indicator_padding = {'right': 4, 'top': 2, 'bottom': 2, 'left': 0}
...
## Type: Padding
# c.tabs.padding = {'right': 5, 'top': 0, 'bottom': 0, 'left': 5}
